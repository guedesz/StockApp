...
class ReceitaItemFragment : Fragment() {

    private var _binding: FragmentReceitaItemBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentReceitaItemBinding.inflate(inflater, container, false)
